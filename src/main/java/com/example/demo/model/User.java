...
public class User {
    ...
    private List<Project> tasksOwned;
    ...
    public List<Project> getTasksCompleted() {
        return tasksOwned.stream()
                .filter(Project::isCompleted)
                .collect(Collectors.toList());
    }

    public List<Project> getTasksInProgress() {
        return tasksOwned.stream()
    ...
    public List<Project> getTasksOwned() {
        return tasksOwned;
    }

    public void setTasksOwned(List<Project> tasksOwned) {
        this.tasksOwned = tasksOwned;
    }
